...
describe "PpMarkdown", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('pp-markdown')

  describe "when the pp-markdown:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'pp-markdown:toggle'
        expect(ppMarkdownPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'pp-markdown:toggle'
        expect(ppMarkdownElement).not.toBeVisible()
